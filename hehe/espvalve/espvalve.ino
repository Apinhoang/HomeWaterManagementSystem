...
char password[] = "Air@nhmadoihoai2107";
String reponse, temp, tds, flow, res, vol, check, haha;
int value;
...
//     Blynk.virtualWrite(V7, flow.toDouble());
//     Blynk.virtualWrite(V8, vol.toDouble());
//   }
//   Blynk.endGroup();
//   //Serial.println("yes");
//   // Serial.println(temp);
